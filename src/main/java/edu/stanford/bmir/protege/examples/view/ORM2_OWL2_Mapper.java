...
/**
 */
public class ORM2_OWL2_Mapper {

    private static final Logger log = LoggerFactory.getLogger(ORM2_OWL2_Mapper.class);
    ...
    public ORM2_OWL2_Mapper(OWLOntologyManager manager) {
    ...
    public ORM2_OWL2_Mapper(String iri) throws Exception {
